...
Devapp is a **React Native app (Expo SDK 57 + Expo Router)** for iOS and Android. Scope is intentionally small: **base (login, module choice, profile) + Devclock (attendance) + Devaccess (access control)**. Do not port other modules unless asked.
